...
public class TransactionDebuggerFrame extends JFrame implements ActionListener, ComponentListener, MouseListener
{
	...
	private void setup()
	{
		...
		// Object[][] cd4 =
		// {{"Alice","Checkings","50"},{"Alice","Savings","30"},{"Peter","Savings","60"},{"Mike","Checking","45"}};
		// Object[][] cd5 =
		// {{"Alice","Checkings","15"},{"Alice","Savings","30"},{"Peter","Savings","60"},{"Mick","Checking","45"}};
		// Object[][] cd6 =
		// {{"Alice","Checkings","15"},{"Alice","Savings","45"},{"Peter","Savings","60"},{"Mick","Checking","45"}};
		//
...
//			graphPanel.add(imageLabel);
		...
		panel_graph.setBounds(35, 200, 100, 100);
...
//		getG1.setActionCommand("Get Graph1");
//		getG2.setActionCommand("Get Graph2");
//		getG3.setActionCommand("Get Graph3");
		
//		getG1.addActionListener(new ButtonClickListener());
//		getG2.addActionListener(new ButtonClickListener());
//		getG3.addActionListener(new ButtonClickListener());
//		getG1.setBounds(graphPanel.getWidth() / 4 - 300 / 2, 0, 450, 250);
//		getG2.setBounds(graphPanel.getWidth() / 4 - 300 / 2, 0, 450, 250);
//		getG3.setBounds(graphPanel.getWidth() / 4 - 300 / 2, 0, 450, 250);
		getG1.setBounds(150, 50, 100, 25);
		getG2.setBounds(300, 50, 100, 25);
		getG3.setBounds(450, 50, 100, 25);
//		getG1.addActionListener(this);
//		getG2.addActionListener();
//		getG3.addActionListener();
...
//		int level = 1;
		...
		int attribute = 0;
		for(int i = 0; i <= level; i++) {
			String nodeName = "t1[" + String.valueOf(i) + "]";
